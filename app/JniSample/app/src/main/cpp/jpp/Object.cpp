...
Object Object::run_v(Class &return_type, const char *method_name, const char *signature,
                     va_list vl) {
    auto ret = invoke_method<jobject>(get_env(), get_jclass(), method_name, signature,
                                      [&](jmethodID method_id) {
...
void Object::run_v(const char *method_name, const char *signature, va_list vl) {
    invoke_method<void>(get_env(), get_jclass(), method_name, signature, [&](jmethodID method_id) {
...
jboolean Object::run_v(jboolean, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jboolean>(get_env(), get_jclass(), method_name, signature,
                                   [&](jmethodID method_id) {
...
jbyte Object::run_v(jbyte, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jbyte>(get_env(), get_jclass(), method_name, signature,
                                [&](jmethodID method_id) {
                                    return get_env()->CallByteMethodV(get_jobject(), method_id, vl);
                                });
}

template<>
jchar Object::run_v(jchar, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jchar>(get_env(), get_jclass(), method_name, signature,
                                [&](jmethodID method_id) {
                                    return get_env()->CallCharMethodV(get_jobject(), method_id, vl);
                                });
}

template<>
jshort Object::run_v(jshort, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jshort>(get_env(), get_jclass(), method_name, signature,
                                 [&](jmethodID method_id) {
                                     return get_env()->CallShortMethodV(get_jobject(), method_id,
                                                                        vl);
                                 });
}
...
jint Object::run_v(jint, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jint>(get_env(), get_jclass(), method_name, signature,
                               [&](jmethodID method_id) {
                                   return get_env()->CallIntMethodV(get_jobject(), method_id, vl);
                               });
}

template<>
jlong Object::run_v(jlong, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jlong>(get_env(), get_jclass(), method_name, signature,
                                [&](jmethodID method_id) {
                                    return get_env()->CallLongMethodV(get_jobject(), method_id, vl);
                                });
}

template<>
jfloat Object::run_v(jfloat, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jfloat>(get_env(), get_jclass(), method_name, signature,
                                 [&](jmethodID method_id) {
                                     return get_env()->CallFloatMethodV(get_jobject(), method_id,
                                                                        vl);
                                 });
}
...
jdouble Object::run_v(jdouble, const char *method_name, const char *signature, va_list vl) {
    return invoke_method<jdouble>(get_env(), get_jclass(), method_name, signature,
                                  [&](jmethodID method_id) {
                                      return get_env()->CallDoubleMethodV(get_jobject(), method_id,
                                                                          vl);
                                  });
}
